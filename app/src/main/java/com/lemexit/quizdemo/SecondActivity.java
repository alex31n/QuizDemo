...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textList.add((TextView) findViewById(R.id.tv_7));
        textList.add((TextView) findViewById(R.id.tv_8));
    ...
    public void onNextButtonClick(View v){
        Toast.makeText(SecondActivity.this, "No More Quiz available", Toast.LENGTH_LONG).show();
    }
